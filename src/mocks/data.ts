...
export const orders: Order[] = [
  {
    ...
    products: [
      { name: 'Sữa tươi 1L', quantity: 1200, unit: 'chai' } as OrderProduct,
    ],
  ...
  },
  {
    ...
    products: [
      { name: 'Sữa tươi 1L', quantity: 300, unit: 'chai' },
    ],
...
export const notifications: AppNotification[] = [
  {
    id: 'N001',
    title: 'Bò #B247 giảm sản lượng 20%',
    description: 'Nguyên nhân dự đoán: sốc nhiệt. Ảnh hưởng -50 lít vào dự báo cung tuần này.',
    date: new Date(),
    type: 'Cảnh báo',
    isRead: false,
  },
  {
    id: 'N002',
    title: 'Thức ăn loại A sắp hết',
    description: 'Thiếu hụt sẽ làm giảm tổng sản lượng nếu không nhập kịp.',
    date: new Date(),
    type: 'Nhắc nhở',
    isRead: false,
  },
...
export const getDashboardMetrics = (): DashboardMetrics => {
  ...
  const recommendations: Recommendation[] =
    gaugeStatus === 'Dư thừa'
      ? [
          { type: 'Cảnh báo Rủi ro', description: 'Dự báo dư thừa ~1,200 lít trong 5 ngày tới do nhà máy ABC giảm đơn hàng.' },
          { type: 'Hành động Đề xuất', description: 'Liên hệ Nhà máy chế biến XYZ (cách 30km), họ đang có nhu cầu sữa bột.', actionLink: '#' },
          { type: 'Hành động Đề xuất', description: 'Cân nhắc giảm khẩu phần ăn tăng cường cho đàn bò #3 trong 3 ngày tới.' },
        ]
      : [
          { type: 'Cơ hội', description: 'Nhu cầu thị trường dự báo tăng mạnh (+15%) vào cuối tuần do thời tiết nắng nóng.' },
          { type: 'Hành động Đề xuất', description: 'Ưu tiên áp dụng khẩu phần ăn tăng sản lượng cho 25 con bò tiềm năng cao nhất.' },
        ]

  const alerts: Alert[] = [
    { description: 'Bò #B247 giảm sản lượng 20%', predictedImpact: '-50 lít vào dự báo cung tuần này' },
    { description: 'Thức ăn loại A sắp hết', predictedImpact: 'Có thể giảm 5% tổng sản lượng nếu không nhập kịp' },
  ]
